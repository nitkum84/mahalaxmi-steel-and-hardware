...
@section('main')
    <!-- shop-details -->
    {{-- UnComment this for Discount Calculation after variable calls --}}
    {{-- @php
        $discounted_value =
            $property->property_value - ($property->property_value * $property->property_discount) / 100;
    @endphp --}}
    <main>
                                            ...
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-1.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-1.jpg" class="img-fluid"
                                                            alt="pro-1">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-2.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-2.jpg" class="img-fluid"
                                                            alt="pro-2">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-3.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-3.jpg" class="img-fluid"
                                                            alt="pro-3">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-4.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-4.jpg" class="img-fluid"
                                                            alt="pro-4">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-5.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-5.jpg" class="img-fluid"
                                                            alt="pro-5">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-6.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-6.jpg" class="img-fluid"
                                                            alt="p-6">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-7.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-7.jpg" class="img-fluid"
                                                            alt="p-7">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-8.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-8.jpg" class="img-fluid"
                                                            alt="pro-8">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-9.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-9.jpg" class="img-fluid"
                                                            alt="pro-9">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-10.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-10.jpg" class="img-fluid"
                                                            alt="pro-10">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-11.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-11.jpg" class="img-fluid"
                                                            alt="pro-11">
                                                    </figure>
                                                </a>
                                            </div>
                                            <div class="slick-slide ">
                                                <a href="img/product/home1-pro-12.jpg" class="product-single">
                                                    <figure class="zoom" onmousemove="zoom(event)"
                                                        ...
                                                        <img src="img/product/home1-pro-12.jpg" class="img-fluid"
                                                            alt="pro-12">
                                                    </figure>
                                                </a>
                                            </div>
                                    ...
                                    <div class="pro-nprist">
                                        ...
                                        <div class="product-info">
                                            <div class="product-actions">
                                                ...
                                                <div class="pro-aff-che">
                                                    <a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}" class="wishlist">
                                                        <span
                                                        ...
                                                        <div class="delivery-block">
                                                            ...
                                                            <div class="space-block">
                                                                ...
                                                                <p>Items returned within 14 days of their original shipment
                                                                    date in same as new
                                                                    condition will be eligible for a full refund or store
                                                                    credit.</p>
                                                            ...
                                                            <div class="single-product-wrap">
                                                                ...
                                                                <div class="product-content">
                                                                    <div class="pro-title-price">
                                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Portable
                                                                                speaker</a></h6>
                                        ...
                                        <div class="product-info">
                                            <p><span>🚚</span> Item will be delivered on or before <span
                                                    id="ten-days-ahead">Mar 3 2025</span></p>
                                        </div>
                                        <div class="product-info">
                                        ...
                                        <div class="product-info">
                                            <div class="product-payment-image">
                                                <ul class="payment-icon">
                                                    <li>
                                                        <a href="index.html"><svg viewBox="0 0 38 24"
                                ...
                                <div class="collection-slider swiper" id="Trending-product">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}" class="pro-img">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Wireless headphones</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Wireless mouse</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Pen drivess</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Smart watch</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Verse earphones</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Wifro camera</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                                            <span class="new-price">$32.00</span>
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Bluetooth earbuds</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                                            <span class="new-price">$44.00</span>
                                        ...
                                        <div class="swiper-slide" data-animate="animate__fadeInUp">
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-title">
                                                        <h6><a href="{{ route('front.product-details',['slug' => 'sample-slug']) }}">Projector leptop</a></h6>
                                                    </div>
                                                    <div class="product-price">
                                                        <div class="pro-price-box">
                                    ...
                                    <div class="collection-button">
                                        <a href="collection.html" class="btn btn-style2"
                                            data-animate="animate__fadeInUp">View all item</a>
                                    </div>
                                </div>
